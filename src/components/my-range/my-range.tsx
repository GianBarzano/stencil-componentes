  ...
  render() {
    return (
      <div class={this.getCssClass()}>
        ...
        <input type="number" value={this.valor} placeholder={this.placeholder} onInput={(event) => this.onInputChange(event)}/>
        <div class="range-container">
          <input type="range" value={this.valor} name="range" id="" class="range" />
        </div>
      </div>
    );
  }
