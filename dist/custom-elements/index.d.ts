/* ClickCompanyComponents custom elements bundle */
...
interface MyTab extends Components.MyTab, HTMLElement {}
export const MyTab: {
  prototype: MyTab;
  new (): MyTab;
};

interface MyTabs extends Components.MyTabs, HTMLElement {}
export const MyTabs: {
  prototype: MyTabs;
  new (): MyTabs;
};
