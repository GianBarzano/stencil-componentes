import { createEvent, h, attachShadow, proxyCustomElement } from '@stencil/core/internal/client';
...
const MyAlert = class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    this.onhided = createEvent(this, "onhided", 7);
  ...
  static get style() { return myAlertCss; }
};
...
const MyTabs = class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
  ...
  static get style() { return myFormCss; }
};
...
const MyInput = class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    this.valueChange = createEvent(this, "valueChange", 7);
  ...
  render() {
    return (h("div", { class: this.getCssClass() }, h("div", { class: "rotulo" }, this.rotulo), h("input", { type: "text", value: this.valor, placeholder: this.placeholder, onInput: (event) => this.onInputChange(event) })));
  }
  get el() { return this; }
  static get watchers() { return {
    "valor": ["valueChanged"]
  }; }
  static get style() { return myInputCss; }
};
...
const MyRange = class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    this.valueChange = createEvent(this, "valueChange", 7);
  ...
  render() {
    return (h("div", { class: this.getCssClass() }, h("div", { class: "rotulo" }, this.rotulo), h("input", { type: "number", value: this.valor, placeholder: this.placeholder, onInput: (event) => this.onInputChange(event) }), h("div", { class: "range-container" }, h("input", { type: "range", value: this.valor, name: "range", id: "", class: "range" }))));
  }
  get el() { return this; }
  static get watchers() { return {
    "valor": ["valueChanged"]
  }; }
  static get style() { return myRangeCss; }
};
...
const MySelect = class extends HTMLElement {
  ...
  render() {
    return (h("div", { class: this.getCssClass() }, h("label", { class: "select-block" }, h("div", { class: "selected-value" }, h("div", { class: "value" }, this.getSelectedNames())), h("input", { type: "text", class: "btn-get-foco", onClick: () => this.handleSelectBlockClick(), onBlur: () => this.handleFocusout() })), h("div", { class: this.getOptionsBlockCssClass() }, this.values.map((item) => (h("div", { class: this.getOptionCssClass(item), onClick: () => this.handleItemClick(item) }, h("div", { class: "option-mark" }), h("div", { class: "option-value" }, item.name)))))));
  }
...
const MyTab = class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    this.tabActivate = createEvent(this, "tabActivate", 7);
    this.name = "Tab";
    this.active = false;
  }
  onClick() {
  ...
  render() {
    return (h("div", { class: this.getCssClass() }, h("slot", null)));
  }
  static get style() { return myTabCss; }
};

const myTabsCss = ".sc-my-tabs-h{display:block}.my-tabs.sc-my-tabs{display:flex}";

const MyTabs$1 = class extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
  }
  ...
  static get style() { return myTabsCss; }
};

const MyAlert$1 = /*@__PURE__*/proxyCustomElement(MyAlert, [2,"my-alert",{"text":[1],"kind":[1],"hide":[32]},[[0,"click","onClick"]]]);
const MyComponent$1 = /*@__PURE__*/proxyCustomElement(MyComponent, [1,"my-component",{"first":[1],"middle":[1],"last":[1]}]);
const MyForm = /*@__PURE__*/proxyCustomElement(MyTabs, [6,"my-form",{"model":[1032],"campos":[16]}]);
const MyInput$1 = /*@__PURE__*/proxyCustomElement(MyInput, [2,"my-input",{"valor":[1025],"rotulo":[1],"placeholder":[1]}]);
const MyRange$1 = /*@__PURE__*/proxyCustomElement(MyRange, [2,"my-range",{"valor":[1025],"rotulo":[1],"placeholder":[1]}]);
const MySelect$1 = /*@__PURE__*/proxyCustomElement(MySelect, [2,"my-select",{"multiple":[4],"model":[1032],"values":[1040],"isOpen":[32]}]);
const MyTab$1 = /*@__PURE__*/proxyCustomElement(MyTab, [6,"my-tab",{"name":[1],"active":[4]},[[0,"click","onClick"]]]);
const MyTabs$2 = /*@__PURE__*/proxyCustomElement(MyTabs$1, [6,"my-tabs",{"activeTab":[1025,"active-tab"]},[[0,"tabActivate","tabChildActivate"]]]);
...
export { MyAlert$1 as MyAlert, MyComponent$1 as MyComponent, MyForm, MyInput$1 as MyInput, MyRange$1 as MyRange, MySelect$1 as MySelect, MyTab$1 as MyTab, MyTabs$2 as MyTabs, defineCustomElements };
